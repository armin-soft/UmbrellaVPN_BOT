...
Bot.setProperty("Package_Start_Date" + User_ID, Package_Start_Date);
Bot.setProperty("Last_Connection_Time" + User_ID, Last_Connection_Time);
...
Bot.setProperty("Duration" + User_ID, Expire_TimeStamp);
