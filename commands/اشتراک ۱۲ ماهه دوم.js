...
Api.sendMessage({
text: "🎁" + User_Message + " *اشتراک " + Subscription + " شما با موفقیت فعال گردید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.*",
parse_mode: "Markdown",
...
"sender": "3000505",
"message": Full_Name + " اشتراک " + Subscription + " شما با موفقیت فعال گردید.\n\nتاریخ و زمان منقضی:\n\n" + Expiration_Date_Text + "\n\nسرور آمبرلا",
"description": {
"summary": "description",
"count_recipient": "1"
}
...
Api.sendMessage({
text: User_Message + " *اشتراک " + Subscription + " شما فعال نگردید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.*",
parse_mode: "Markdown",
reply_markup: { inline_keyboard: [
