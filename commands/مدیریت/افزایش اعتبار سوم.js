...
let Increase_Credit_User_ID = Bot.getProperty("Increase_Credit_User_ID");
let Full_Name = Bot.getProperty("Full_Name" + Increase_Credit_User_ID);
...
let Increase_Credit_Money = parseFloat(English_Message);

if (isNaN(Increase_Credit_Money) || Increase_Credit_Money <= 0) {
Bot.sendMessage("❌ مبلغ وارد شده معتبر نمی باشد.");
return;
}

let Money = Libs.ResourcesLib.anotherUserRes(
"Money",
Increase_Credit_User_ID
);
...
Money.add(Increase_Credit_Money);
Bot.runCommand("تاریخ و زمان");
Api.sendMessage({
text: "*✅مدیریت گرامی* [" + Admin_Full_Name + "](tg://user?id=" + Admin_User_ID + ") *مبلغ " + Format_Number(Increase_Credit_Money) + " اعتبار حساب کاربری کاربر " + Gender + " " + Full_Name + " با موفقیت شارژ گردید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.*",
parse_mode: "Markdown",
...
Api.sendMessage({
chat_id: Increase_Credit_User_ID,
text: "* [" + Full_Name + "](tg://user?id=" + Increase_Credit_User_ID + ") *لحظاتی پیش مبلغ " + Format_Number(Increase_Credit_Money) + " اعتبار حساب کاربری شما توسط مدیریت شارژ گردید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n🌏ارز کنونی:🇮🇷ایران - تومان\n💳اعتبار کنونی: " + Format_Number(Money.value()) + "*",
parse_mode: "Markdown"
});