...
text:"*🌹مدیریت گرامی* [" + Admin_Full_Name + "](tg://user?id=" + Admin_User_ID + ") *به بخش اعتبار حساب کاربری خوش آمدید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.*",
parse_mode:"Markdown",
reply_markup:{inline_keyboard:[
[{text: "➕افزایش اعتبار" , callback_data: "افزایش اعتبار اول"},{text: "➖کسر اعتبار" , callback_data: "کسر اعتبار اول"}],
[{text: "👁مشاهده اعتبار", callback_data: "مشاهده اعتبار اول"}],
