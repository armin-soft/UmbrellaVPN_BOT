/*CMD
  command: غیر فعالسازی کلاینت اول
  help: 
  need_reply: false
  auto_retry_time: 
  folder: مدیریت
...
text:"🔄غیر فعالسازی کلاینت در حال بار گذاری می باشد...",
show_alert:false
})
...
text: "*🌹مدیریت گرامی* [" + Admin_Full_Name + "](tg://user?id=" + Admin_User_ID + ") *به بخش غیر فعالسازی کلاینت خوش آمدید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.*",
parse_mode: "Markdown",
...
Bot.runCommand("غیر فعالسازی کلاینت دوم");