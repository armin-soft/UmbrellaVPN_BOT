...
text:"🔄اطلاع رسانی در حال بار گذاری می باشد...",
show_alert:false
})
...
text: "*🌹مدیریت گرامی* [" + Admin_Full_Name + "](tg://user?id=" + Admin_User_ID + ") *به بخش اطلاع رسانی خوش آمدید.\n\n" + Date_Time + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.*",
parse_mode: "Markdown",
...
Bot.runCommand("اطلاع رسانی دوم");